 ...
 */
export const envTestRoute = new Elysia({ prefix: '/api', tags: ['Development'] }).get(
  '/env-test',
  () => {
    return {
  ...
  },
  {
    detail: {
      ...
      description:
        'Returns current environment configuration, server settings, and runtime features for debugging and validation',
