...
export class GeneratorUtils {
  ...
  static getDefaultPath(type: string, name: string): string {
    const kebabName = GeneratorUtils.toKebabCase(name)
    const pascalName = GeneratorUtils.toPascalCase(name)
  ...
  static getTemplateVariables(
    ...
    return {
      ...
      kebabName: GeneratorUtils.toKebabCase(name),
      camelName: GeneratorUtils.toCamelCase(name),
      pascalName: GeneratorUtils.toPascalCase(name),
      snakeName: GeneratorUtils.toSnakeCase(name),
  ...
  static toPascalCase(str: string): string {
    return GeneratorUtils.capitalize(GeneratorUtils.toCamelCase(str))
  }
